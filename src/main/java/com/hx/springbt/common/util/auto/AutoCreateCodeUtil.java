...
public class AutoCreateCodeUtil {
    ...
    //模板目录
    private final static String TEMPLATE_PATH = "D:/workspace/springbt/src/main/resources/freemarker";
    private final static String TEMPLATE_DAO_FILE = "Dao.ftl";
    private final static String TEMPLATE_SERVICE_FILE = "Service.ftl";
    private final static String TEMPLATE_SERVICE_IMPL_FILE = "ServiceImpl.ftl";
